...
class BlackFieldSet(FieldSet):
    ...
    def opt_out(cls, tgt: Target) -> bool:
        opt_out = tgt.get(SkipBlackField).value
...
async def setup_black(setup_request: SetupRequest, black: Black, python_setup: PythonSetup) -> Setup:
    ...
    config_files = await Get(ConfigFiles, ConfigFilesRequest, black.config_request(source_files_snapshot.dirs))
